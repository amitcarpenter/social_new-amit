    ...
    <>
      <div className="container-fluid dashboard">
        <div className="row">
          ...
          <nav
            id="sidebar"
            className="col-md-3 col-lg-2 d-md-block bg-white sidebar"
          >
            <div className="sidebar-sticky">
              ...
              <ul className="nav flex-column">
                ...
                >
                  ...
                  >
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M8.5 7C8.5 5.93913 8.92143 4.92172 9.67157 4.17157C10.4217 3.42143 11.4391 3 12.5 3C13.5609 3 14.5783 3.42143 15.3284 4.17157C16.0786 4.92172 16.5 5.93913 16.5 7C16.5 8.06087 16.0786 9.07828 15.3284 9.82843C14.5783 10.5786 13.5609 11 12.5 11C11.4391 11 10.4217 10.5786 9.67157 9.82843C8.92143 9.07828 8.5 8.06087 8.5 7ZM8.5 13C7.17392 13 5.90215 13.5268 4.96447 14.4645C4.02678 15.4021 3.5 16.6739 3.5 18C3.5 18.7956 3.81607 19.5587 4.37868 20.1213C4.94129 20.6839 5.70435 21 6.5 21H18.5C19.2956 21 20.0587 20.6839 20.6213 20.1213C21.1839 19.5587 21.5 18.7956 21.5 18C21.5 16.6739 20.9732 15.4021 20.0355 14.4645C19.0979 13.5268 17.8261 13 16.5 13H8.5Z"
                      fill="#A7A7A7"
                    />
                  </svg>
                  <a
                ...
                >
                  ...
                  >
                    <g clip-path="url(#clip0_226_99)">
                      <path
                        d="M5 0C4.17031 0 3.5 0.670312 3.5 1.5V6H6.5V1.5C6.5 0.670312 5.82969 0 5 0ZM14 0C13.1703 0 12.5 0.670312 12.5 1.5V6H15.5V1.5C15.5 0.670312 14.8297 0 14 0ZM2 7.5C1.17031 7.5 0.5 8.17031 0.5 9C0.5 9.82969 1.17031 10.5 2 10.5V12C2 15.6281 4.57812 18.6562 8 19.35V22.5C8 23.3297 8.67031 24 9.5 24C10.3297 24 11 23.3297 11 22.5V19.35C14.4219 18.6562 17 15.6281 17 12V10.5C17.8297 10.5 18.5 9.82969 18.5 9C18.5 8.17031 17.8297 7.5 17 7.5H2Z"
                        fill="#A7A7A7"
                      />
                    </g>
                    <defs>
                ...
                >
                  ...
                  >
                    <path
                      d="M17.5 9.99997C17.6 9.99997 17.69 10.01 17.78 10.01L4.89 4.57997C4.23 4.30997 3.5 4.78997 3.5 5.50997V9.21997C3.5 9.67997 3.81 10.08 4.26 10.19L11.5 12L4.26 13.81C3.81 13.92 3.5 14.32 3.5 14.78V18.49C3.5 19.21 4.23 19.69 4.89 19.41L10.5 17.05V17C10.5 13.14 13.64 9.99997 17.5 9.99997Z"
                      fill="#A7A7A7"
                    />
                    <path
                      d="M17.5 12C14.74 12 12.5 14.24 12.5 17C12.5 19.76 14.74 22 17.5 22C20.26 22 22.5 19.76 22.5 17C22.5 14.24 20.26 12 17.5 12ZM18.79 19L17.14 17.35C17.0467 17.2571 16.9929 17.1317 16.99 17V14.5C16.99 14.22 17.21 14 17.49 14C17.77 14 17.99 14.22 17.99 14.5V16.79L19.49 18.29C19.69 18.49 19.69 18.8 19.49 19C19.3 19.2 18.99 19.2 18.79 19Z"
                      fill="#A7A7A7"
                    />
                  </svg>
                  <a
          ...
          >
            <div
              id="dashboardContent"
              style={{
                display: activeContent === "dashboard" ? "block" : "none",
              }}
            >
              <Myprofile />
            </div>
            ...
            <div
              id="menu2Content"
              style={{ display: activeContent === "menu2" ? "block" : "none" }}
            >
              <Accountoverview />
            </div>
            <div
              id="menu2Content"
              style={{ display: activeContent === "menu3" ? "block" : "none" }}
            >
              <Integration />
            </div>
            ...
            <div
              id="menu2Content"
              style={{ display: activeContent === "menu4" ? "block" : "none" }}
            >
              <Post />
            </div>
            ...
            <div
              id="menu2Content"
              style={{ display: activeContent === "menu5" ? "block" : "none" }}
            >
              <Sedule />
            </div>
            ...
            <div
              id="menu2Content"
              style={{ display: activeContent === "menu6" ? "block" : "none" }}
            >
              <Analytics />
            </div>
            ...
            <div
              id="menu2Content"
              style={{ display: activeContent === "menu7" ? "block" : "none" }}
            >
              <Users />
            </div>
