        ...
        <>
            <div className="Users">
                <div className="container">
                    <h2>Users</h2>
                    <p className='para_p'>You can see all your active and inactive users.</p>
                    <div className="row color_div">
                        ...
                        <div className="sign_main_col col-12 col-lg-3 col-md-3 ">
                            ...
                            <i className='cross_icn'> <FontAwesomeIcon icon={faTimes} /></i>
                            ...
                            <ul className='d-flex icon_icon'>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <g clip-path="url(#clip0_344_412)">
                                        <path d="M18.375 0H5.625C2.5184 0 0 2.5184 0 5.625V18.375C0 21.4816 2.5184 24 5.625 24H18.375C21.4816 24 24 21.4816 24 18.375V5.625C24 2.5184 21.4816 0 18.375 0Z" fill="url(#paint0_radial_344_412)" />
                                        <path d="M18.375 0H5.625C2.5184 0 0 2.5184 0 5.625V18.375C0 21.4816 2.5184 24 5.625 24H18.375C21.4816 24 24 21.4816 24 18.375V5.625C24 2.5184 21.4816 0 18.375 0Z" fill="url(#paint1_radial_344_412)" />
                                    ...
                                    <defs>
                                        <radialGradient id="paint0_radial_344_412" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(6.375 25.8485) rotate(-90) scale(23.7858 22.1227)">
                                            <stop stop-color="#FFDD55" />
                                            <stop offset="0.1" stop-color="#FFDD55" />
                                            <stop offset="0.5" stop-color="#FF543E" />
                                            <stop offset="1" stop-color="#C837AB" />
                                        </radialGradient>
                                        <radialGradient id="paint1_radial_344_412" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(-4.02009 1.72884) rotate(78.681) scale(10.6324 43.827)">
                    ...
                    <div className="row color_div2">
                        ...
                        <div className="sign_main_col col-4 col-lg-3 col-md-3">
                            <p className='jhon_doe'>jhon.doe</p>
                            <p className='jhon_doe'>johndoe@gmail.com</p>
                        </div>
                        <div className="sign_main_col col-12 col-lg-3 col-md-3">
                    ...
                    <div className="row color_div3">
                        ...
                        <div className="sign_main_col col-4 col-lg-3 col-md-3">
                            <p className='jhon_doe'>jhon.due</p>
                            <p className='jhon_doe'>johndoe@gmail.com </p>
                        </div>
                        <div className="sign_main_col col col-12 col-lg-3 col-md-3">
