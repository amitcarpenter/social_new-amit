      ...
      <div className="container">
        ...
        <div className="row main_row">
          <div className="col-12 col-md-6 ">
            <Link to="menu5" className="post_add_button">
              + New Post
            </Link>
          </div>
          <div className="col-12 col-md-6 ">
        ...
        <div className="row">
          <div className="bg-[#FFFFFF] p-3 rounded-lg flex flex-col md:flex-row  gap-4">
            ...
            <div className="w-full">
              <div className="flex justify-end gap-3">
                ...
                <span className="w-[32px] h-[32px] shrink-0">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="32"
                    height="32"
              ...
              <div className="md:w-[95%]">
                <h6 className="text-[#11264D]">Design critiques at Figma</h6>
                <p className="text-[rgba(17, 38, 77, 0.60)] font-[400] ">
                  ...
                  dapibus orci eu eros tempus efficitur. Nulla rhoncus arcu nec
                  dictum condimentum. Aenean sapien leo,.
                </p>
              </div>
          ...
          <div className="bg-[#FFFFFF] p-3 rounded-lg flex flex-col md:flex-row  gap-4 mt-5">
            <div className="relative">
              <img src="asset/Rectangle.png" alt="" />
