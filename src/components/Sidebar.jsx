        ...
        <div className=' h-full bg-white'>
...

            {
                sidebarmanu.map((item) => (
                    <SidebarLink handleClose={handleClose} item={item} key={item.id} />
                ))
            }
...
const SidebarLink = ({ handleClose, item }) => {
    ...
    return (
        <p onClick={handleClick} className={`flex items-center gap-3 cursor-pointer
         ${pathname === item.path ? "border-r-sky-600 border-r-4 text-blue-600" : "text-gray-600"}  hover:text-gray-700 py-2 mb-2`}>
            <span>{item.icon}</span>
